...
<!--Remember to put tr closing tag after td -->
...
<table width="800" border="0" align="center">
  <tbody>
   ...
   <!--Use h3 for all pages with a width of 800 so it stays consistent and bold letting; also center everything-->
...
<li><a href="index.html">Final Website</a></li>
 ...
 <!--Put everything in a table so that I can center things on my page. If I don't want to see the line around the table then put border of 0.-->
